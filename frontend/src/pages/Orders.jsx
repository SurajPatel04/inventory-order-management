  ...
  return (
    <div className="space-y-6 sm:space-y-8 w-full">
      ...
      <Modal isOpen={isFormOpen} onClose={resetForm} title="Create New Order">
        <form onSubmit={handleSubmit} className="space-y-4">
          ...
          <div>
            ...
            <input required type="number" min="1" value={form.quantity} onChange={e => setForm({...form, quantity: e.target.value})} className="block w-full rounded-xl border-gray-200 bg-white shadow-sm p-2.5 border focus:border-[#432DD7] focus:ring-2 focus:ring-[#432DD7]/20 transition-all outline-none" />
          </div>
      ...
      <motion.div 
        ...
        className="bg-white rounded-2xl shadow-sm border border-gray-100/60 w-full"
      >
        <div className="overflow-x-auto sm:overflow-visible w-full pb-24 sm:pb-0">
                  ...
                  <React.Fragment key={order.id}>
                    ...
                    >
                      ...
                      <td className="px-4 sm:px-6 py-4 whitespace-nowrap text-right text-sm font-medium flex justify-end gap-1 sm:gap-2">
                        <button onClick={(e) => { e.stopPropagation(); setExpandedId(isExpanded ? null : order.id); }} className="text-gray-400 hover:text-[#432DD7] p-2 rounded-lg hover:bg-[#432DD7]/10 transition-all">
                          <ChevronDown className={`w-5 h-5 transition-transform duration-200 ${isExpanded ? 'rotate-180 text-[#432DD7]' : ''}`} />
                        </button>
                              ...
                              <div className="px-6 py-5">
                                <div className="flex justify-between items-center mb-3">
                                  <h4 className="text-sm font-semibold text-gray-900 flex items-center">
                                    <ShoppingBag className="w-4 h-4 mr-2 text-[#432DD7]" /> Order Details
                                  </h4>
                                  ...
                                  <table className="min-w-full divide-y divide-gray-100 text-sm">
                                    ...
                                    <tfoot className="bg-gray-50/80 border-t border-gray-100">
                                      <tr>
                                        ...
                                        <td className="px-4 py-3 text-right font-bold text-[#432DD7] text-base">${order.total_amount.toFixed(2)}</td>
                                      </tr>
                                    </tfoot>
                                  </table>
                                </div>
